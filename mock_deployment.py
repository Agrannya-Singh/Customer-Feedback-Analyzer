...
# Try-except block for loading data
try:
    df = pd.read_csv('car_rental_feedback_sentiment.csv - Copy (1).csv')
except FileNotFoundError:
    raise FileNotFoundError("The CSV file 'car_rental_feedback_sentiment_training.csv' was not found. Please ensure it's in the correct directory.")
...
">
  <img
    src="https://upload.wikimedia.org/wikipedia/en/thumb/c/c5/Vellore_Institute_of_Technology_seal_2017.svg/300px-Vellore_Institute_of_Technology_seal_2017.svg.png"
    alt="VIT Logo"
    style="
      height: 48px;
      width: auto;
...
Enter your car rental review below. The app will predict the sentiment (Positive, Neutral, Negative).
"""
...
iface = gr.Interface(
    ...
    theme="default"  # Explicitly set theme
)
